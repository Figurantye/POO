...
function dobrarParesMenoresQueCinco(numeros, numerosDobrados, numPar) {
    numPar = numeros.filter(function (num) { return num % 2 === 0 && num < 5; });
    numerosDobrados = numPar.map(function (num) { return num * 2; });
